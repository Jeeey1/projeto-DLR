      ...
      <div class="col-md-4 mb-3">
        <div class="card h-100 shadow-sm border-primary">
          <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
            <h5 class="card-title text-primary" style="font-weight: 600;">Tem um novo assunto?</h5>
            <a href="./blog/criar-post.php" class="btn btn-primary mt-2" style="border-radius: 8px;">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-end pe-4">
                      <a href="./blog/editar-post.php?id=<?php echo $p['id']; ?>"
                        class="text-primary text-decoration-none" title="Editar">
